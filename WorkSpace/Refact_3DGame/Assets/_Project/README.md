...
신규 진입점과 컨테이너 틀은 [01.Boot 안내](01.Boot/README.md)에서 확인한다. Project_P의 진입점·씬 로딩·기능별 파일 구분을 참고했다. 현재 Boots를 비워 두고 컨테이너부터 정리하는 단계다. 실행 연결은 이후에 진행한다.

| 폴더 | 역할 |
| --- | --- |
| [00.Scene](00.Scene/README.md) | Start·Ground·UnderGround 씬과 지하 조명 복원 |
| [01.Boot](01.Boot/README.md) | Boots 진입점, 컨테이너 소유 관계와 이전 순서의 틀 |
| [02.Core/WorldObjects](02.Core/WorldObjects/README.md) | 객체 생성·갱신·회수와 프리팹 풀 |
| [03.Settings](03.Settings) | 공통 렌더링 설정 |
| [04.Loading](04.Loading/README.md) | MapContainer의 씬 캐시·참조 횟수 관리 |
| [05.Manager](05.Manager/README.md) | 관리 코드 자리 유지. 현재 MapManager는 제거 |
...
00.Scene → 01.Boot → 02.Core → 03.Settings → 04.Loading → 05.Manager 순으로 시작·기반·설정·로딩·관리 위치를 찾는다. 폴더 번호가 Unity 콜백 실행 순서를 결정하지는 않는다. 현재 Start의 자동 맵 로딩은 제거했으며 MapContainer의 실행 연결은 없다.
...
2. 진입점에서 각 컨테이너를 갱신한다. 현재 Boots에는 이 연결이 없다.
