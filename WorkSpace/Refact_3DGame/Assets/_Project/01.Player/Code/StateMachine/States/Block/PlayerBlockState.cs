...
namespace Characters.Player.StateMachine.States.Block
{
    ...
    internal sealed class PlayerBlockState : IPlayerState
    {
        ...
        public void Enter()
        {
            ...
            stateMachine.Movement.BeginGuardTurn();
            if (IsGuardReady)
                stateMachine.Movement.UpdateGuardTurn(1f);
        ...
        public void Update(float deltaTime, PlayerStateInput input)
        {
            ...
            animationController.UpdateBlockMove(stateMachine.Movement.GetLocalMoveVelocity(),
                stateMachine.Movement.GuardMoveSpeed, deltaTime);
            guardHitBox?.SetGuardActive(IsGuardReady);
        }
        ...
        private void UpdateGuardReady(float deltaTime)
        {
            ...
            stateMachine.Movement.UpdateGuardTurn(guardRaiseElapsedTime / guardRaiseDuration);
