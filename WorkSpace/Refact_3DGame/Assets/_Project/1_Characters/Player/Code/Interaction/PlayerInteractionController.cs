...
namespace Characters.Player.Interaction
{
    ...
    public sealed class PlayerInteractionController : MonoBehaviour
    {
        ...
        public event Action<PlayerInteractionGuide> InteractionGuideChanged;
        ...
        private void Start()
        {
            ...
            interactionDetector = new PlayerInteractionDetector(
                ...
                interactionRange);
            interactionDetector.CurrentGuideChanged +=
        ...
        public bool Interact()
        {
            if (!enabled ||
                ...
                !interactionDetector.CurrentGuide.CanInteract)
            {
                return false;
            }
        ...
        {
            InteractionGuideChanged?.Invoke(guide);
        }
    }
}
