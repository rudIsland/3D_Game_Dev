...
namespace rudIsland.RPG3D.Characters.Enemies.Boss.DemonSwordsman
{
        ...
        IDemonSwordsmanState
    {
        ...
        private static readonly string NoAttackName = string.Concat((char)0xC5C6, (char)0xC74C);
        private DemonSwordsmanAttackPattern currentAttack;
        private DemonSwordsmanAttackPattern followUpAttack;
        private bool branchWasRead;
        private bool finishRequested;
        private int attacksBeforeReposition;
