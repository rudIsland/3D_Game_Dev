...
namespace rudIsland.RPG3D.Editor
{
    ...
    public static class DemonSwordsmanBossAssetBuilder
    {
        ...
        private const string ModelsRoot = BossRoot + "/Models";
        private const string MaterialsRoot = BossRoot + "/Materials";
        private const string TexturesRoot = BossRoot + "/Textures";
        private const string SwordAnimationsRoot =
            BossRoot + "/Animations/Sword";
        private const string BeastAnimationsRoot =
            BossRoot + "/Animations/Beast";
        private const string AnimatorRoot =
            BossRoot + "/Animations/Controllers";
        private const string SettingsRoot = BossRoot + "/Settings";
        private const string PrefabsRoot = BossRoot + "/Prefabs";

        private const string ModelPath = ModelsRoot + "/base_mesh.fbx";
        private const string HandSwordModelPath =
            ModelsRoot + "/sword_hand.fbx";
        private const string BodyMaterialPath =
            MaterialsRoot + "/M_body_set_1.mat";
        private const string SwordMaterialPath =
        ...
        private static readonly string[] SwordAnimationFileNames =
        {
        ...
        private static readonly string[] BeastAnimationFileNames =
        {
            "@anim_idle_1.FBX",
            "@anim_run_1.FBX",
