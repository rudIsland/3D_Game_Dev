...
namespace rudIsland.RPG3D.Characters.Enemies.Boss.DemonSwordsman
{
    ...
    {
        private const float TurnAnimationAngle = 65f;
        private const float LocomotionFadeTime = 0.15f;

        private readonly DemonSwordsmanStateMachine stateMachine;
        private DemonSwordsmanMoveMode currentMode;
        private DemonSwordsmanMoveMode nextMode;
        private float circleDirection;

        public string Name => currentMode.ToString();
