...
namespace Characters.Enemies.NightShade
{
        ...
        NightShadeSwordRecoveryActionBase
    {
        ...
        public override bool CanStart(out NightShadeSwordActionRejectReason rejectReason)
        {
            if (!base.CanStart(out rejectReason))
                return false;
            if (Movement is NightShadeSwordMovement movement &&
                !movement.CanMoveForRecovery(TargetStatus.TargetPosition, moveType,
                    Recovery.MoveSpeed * Recovery.MoveDuration))
            {
                rejectReason = NightShadeSwordActionRejectReason.MovementBlocked;
                return false;
            }
            return true;
        }
