...
namespace Characters.Player.Stats
{
    ...
    {
        internal static bool HasUpgrade(PlayerStatUpgradeSession session, StatueUpgradeType upgradeType)
        {
            return session.HasUpgrade(upgradeType);
        }
            ...
            PlayerStateMachine stateMachine)
        {
            ...
            if (!session.TryActivate(upgradeType))
            {
                return false;
            }
