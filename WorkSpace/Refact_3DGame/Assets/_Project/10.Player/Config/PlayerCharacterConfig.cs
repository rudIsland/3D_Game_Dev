...
namespace Player
{
    ...
    internal sealed class PlayerMovementSettings
    {
        ...
        [SerializeField, Min(0f)] private float directionChangeAcceleration = 60f;
        ...
        internal float DirectionChangeAcceleration => directionChangeAcceleration;
    ...
    internal sealed class PlayerMovementRuntimeConfig
    {
        ...
        internal float DirectionChangeAcceleration { get; }
        ...
        internal PlayerMovementRuntimeConfig(PlayerMovementSettings source)
        {
            ...
            DirectionChangeAcceleration = source.DirectionChangeAcceleration;
    ...
    internal sealed class PlayerCombatRuntimeConfig
    {
        ...
        {
            Life = new CharacterLifeSettings(source.MaxHealth, source.StopPointLimit,
                source.StopPointRecoverDelay, source.StopPointRecoverSpeed);
