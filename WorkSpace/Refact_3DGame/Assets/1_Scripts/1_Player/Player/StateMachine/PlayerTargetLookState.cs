...
public class PlayerTargetLookState : PlayerBaseState
{
    ...
    public override void Exit()
    {
        ...
        if (stateMachine.inputReader != null)
        {
            ...
            stateMachine.targeter.CanCel(); //타겟취소
    ...
    public override void Tick(float deltaTime)
    {
        ...
        stateMachine.verticallDir = JumpAndGravity(deltaTime);
        stateMachine.horizontalDir = CalculateMove(deltaTime);
        // 이동 처리
        Move(deltaTime);
        // 애니메이션 업데이트
    ...
    //점프와 중력
    private Vector3 JumpAndGravity(float deltaTime)
    {
